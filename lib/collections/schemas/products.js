...
export const EstimatedFCCRange = new SimpleSchema({
  range: {
    type: String,
    defaultValue: "0.00"
  },
...
hbgBodyMaterial:{
  type: String,
  label: "HbgBodyMaterial",
  optional:true
},
hbgHardwareFinishh:{
  type: String,
  label: "HbgHardwareFinishh",
  optional:true
},
hbgHandleType:{
  type: String,
...
hbgLongHandleDrop:{
  type: String,
  label: "HbgLongHandleDrop",
  optional:true
},
hbgShortHandleDrop:{
  type: String,
  label: "HbgShortHandleDrop",
  optional:true
},
hbgninteriorPockets:{
  type: String,
  label: "HbgninteriorPockets/Details",
  optional:true
},
hbgntexteriorPockets:{
  type: String,
  label: "HbgntexteriorPockets/Details",
  optional:true
},
hbgClosure:{
  type: String,
...
export const ProductFilter = new SimpleSchema({
  brand: {
    type: String,
    label: "Brands",
    optional:true
