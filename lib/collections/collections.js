...
Accounts.attachSchema(Schemas.UserBrand);
...
//Products.attachSchema(Schemas.VarientOption, { selector: { type: "variant" } });
Products.attachSchema(Schemas.ProductFilter, { selector: { type: "simple" } });
 ...
 * Prepacks Collection
 */
export const Prepacks = new Mongo.Collection("Prepacks");
Prepacks.attachSchema(Schemas.Prepacks);
