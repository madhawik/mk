...
xhr.open("GET", "/resources/products/download.jpg");
...
xhr.send()*/
  //const file = new File(["C:/Users/s-plmshf/Desktop/"], "download");
  //console.log(file);
  /*fileObj.attachData(imgUrl, function (error) {
        if (error){
          throw error;
          console.log(error);
        }
          ...
          console.log(fileObj)
          //return: Object { createdByTransform: false, metadata: Object, original: Object, data: Object }
        }
