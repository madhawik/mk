...
const fieldGroups = {
  ...
  estimatedFCC: { group: "variantDetails" },
  wholesalePrice: { group: "variantDetails" },
  colorCode:{ group: "variantDetails" },
  productionColor:{ group: "variantDetails" },
  minQty: { group: "variantDetails" },
  nrf: { group: "variantDetails" },
  size: { group: "variantDetails" },
